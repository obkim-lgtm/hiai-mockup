...
- **평가 설계 작업 전 → [sessions/2026-09-03.md](sessions/2026-09-03.md) 맨 아래 "2026-09-08 오후" 절과 "▶ 이어받기"** — 작업본 **`../output/evaluation_design_v9.html`**(v8은 회의록·PRD에 공유된 주소라 보존). 설계는 채점기준까지 = 완료, 그 위에 **AI 채점 정확도 높이기 3단계**(① 빈 활동지·문항 확정 ② 채점기준 연결(매트릭스) ③ 모범답안). **v7의 AI 진단·루브릭 수정 제안은 삭제됨**
