...
(function () {
  var CSS = [
    ...
    '.sg-dialog{background:#fff;border-radius:24px;box-shadow:0 4px 12px rgba(95,102,178,.16);width:720px;max-width:100%;position:relative;margin:auto;font-family:"NanumSquareRound",-apple-system,sans-serif;}',
    '.sg-head{padding:24px 24px 4px;}',
    '.sg-title{font-size:18px;font-weight:800;color:#222631;margin:0;line-height:1.35;}',
    '.sg-sub{font-size:14px;color:#808080;margin:6px 0 0;line-height:1.55;}',
    '.sg-x{position:absolute;top:11px;right:11px;width:36px;height:36px;border-radius:6px;border:none;background:transparent;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;line-height:1;color:#808080;}',
    '.sg-x:hover{background:#F0F0F0;}',
    '.sg-body{padding:16px 24px 0;display:flex;flex-direction:column;gap:12px;}',
    '.sg-foot{padding:8px 24px 16px;display:flex;align-items:center;justify-content:flex-end;gap:12px;}',
    '.sg-ok{height:40px;border-radius:8px;font-weight:700;font-size:16px;font-family:inherit;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;line-height:1;vertical-align:middle;padding:0 16px;border:none;background:#7E44FB;color:#fff;}',
    '.gcase{border:1px solid #E6E6E6;border-radius:14px;padding:18px;display:flex;align-items:center;gap:20px;}',
    '.gcase-txt{flex:1;min-width:0;}',
    '.gcase-title{font-size:16px;font-weight:800;color:#333;margin:0 0 6px;line-height:1.4;}',
    '.gcase-desc{font-size:16px;color:#494949;line-height:1.65;margin:0;}',
    '.gcase-desc b{color:#333;}',
    '.gcase-figs{display:flex;gap:10px;flex-shrink:0;}',
    '.gfig{width:132px;display:flex;flex-direction:column;gap:6px;}',
    '.gfig-frame{height:96px;background:#F0F0F0;border-radius:10px;display:flex;align-items:center;justify-content:center;overflow:hidden;position:relative;}',
    '.gfig-mark{position:absolute;top:6px;left:6px;width:20px;height:20px;border-radius:50%;display:flex;align-items:center;justify-content:center;}',
    '.gfig-mark i{width:13px;height:13px;color:#fff;}',
  ...
  var HTML =
    '<div class="sg-dialog">' +
      ...
      '<div class="sg-head">' +
        '<h3 class="sg-title">잘 채점되는 과제물 안내</h3>' +
        '<p class="sg-sub">아래 세 가지만 확인하면 AI가 학생 답안을 훨씬 정확하게 읽고 채점해요.</p>' +
      '</div>' +
      '<div class="sg-body">' +
